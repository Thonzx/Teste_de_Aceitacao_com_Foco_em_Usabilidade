...
app.get("/pesquisar", (req, res) => {
  const termo = req.query.termo; // Obter o termo pesquisado
  console.log("Termo pesquisado:", termo); // Log do termo
  ...
  db.query(sql, valores, (err, results) => {
    ...
    console.log("Livros encontrados:", results); // Log dos resultados
    res.render("resultados_pesquisa", { livros: results, termo });
  });
});
